...
void RotarySliderWithLabels::paint(juce::Graphics &g)
{
    ...
    auto startAng = degreesToRadians(180.f + 45.f); // 0 value
    auto endAng = degreesToRadians(180.f - 45.f) + MathConstants<float>::twoPi; // max value
...
void SimpleEQAudioProcessorEditor::resized()
{
    ...
    auto bounds = getLocalBounds();
    float hRatio = 25.f / 100.f; // JUCE_LIVE_CONSTANT(33) / 100.f; // amazing live UI edit
